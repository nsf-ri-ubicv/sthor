/* Generated by Cython 0.15.1 on Wed Mar  7 00:17:36 2012 */
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                __pyx_v_oy = 0;
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_13, __pyx_t_10, __pyx_t_12, __pyx_t_14, __pyx_t_6, __pyx_t_4, __pyx_t_9, __pyx_t_8, __pyx_t_7, __pyx_t_5, __pyx_t_11)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_ox) firstprivate(__pyx_v_oy) lastprivate(__pyx_v_oy) lastprivate(__pyx_v_iy) lastprivate(__pyx_v_ix) lastprivate(__pyx_v_oz) lastprivate(__pyx_v_iz)
                    #endif /* _OPENMP */
